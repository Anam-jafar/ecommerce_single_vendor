...
<html
  ...
  <head>
    ...
    <meta
      name="viewport"
      content="width=device-width, initial-scale=1.0d, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="demo fw-bold ms-2">accessoryHub</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Products &amp; Categories</span>
            </li>
            <!-- Category -->
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{ route('addProduct') }}" class="menu-link">
                    <div data-i18n="Without navbar">Add Products</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{ route('adminDeliveredOrders') }}" class="menu-link">
            ...
            <li class="menu-item">
              <a
                ...
                <div data-i18n="Documentation">Customers</div>
              </a>
            </li>
          </ul>
        </aside>
          ...
          <nav
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <i class='bx bx-user-circle' style='font-size: 2em;'></i>
